...
bool create_ipfs_client_to_ipfs_server_connections(int *, ipfs_client_conf_struct *);
void get_output_list_command(server_chunks_collate_struct *);
bool auth_ipfs_client_to_ipfs_server_connections(int *, ipfs_client_conf_struct *);
void setup_ipfs_client_to_ipfs_server_connections(int **, ipfs_client_conf_struct *);
void tear_ipfs_client_to_ipfs_server_connections(int *, ipfs_client_conf_struct *);
